 ...
 *   - In place — returning a new matrix does not count.
 ...
 *   Target: O(n^2) time, O(1) space — transpose the matrix, then reverse each row. (Anticlockwise: transpose, then reverse each column.)
 * ----------------------------------------------------------------------
 */
